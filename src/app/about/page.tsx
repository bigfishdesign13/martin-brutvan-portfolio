      ...
      <div className="grid grid-cols-about w-full gap-8">
        ...
        <div>
          ...
          <p className="subheading1 mb-6">
            ...
            years experience in visual and <strong>UX design</strong>,{" "}
            <strong>web development</strong>, and <strong>accessibility</strong>
            . I work seamlessly with both designers and developers, often
          ...
          <p className="mb-6">
            ...
            projects, handling all aspects of the web development cycle from
            start to finish – including designing wireframes and mockups, coding
